<template>
    <div>
        <div class="comment ">
            <div class="inside">
                <Row>
                    <Col span="24" v-for="(value,index) in message" :key="index">
                        <div class="content">
                            <div>
                                <h4>{{value.user}}</h4>
                                <Tag>{{value.tag1}}</Tag>
                ...
                message:[
                    {
                        ...
                        tag2:"设计语言",
                        tag3:"蚂蚁金服",
                        p:"段落示意：蚂蚁金服设计平台 ant.design，用最小的工作量，无缝接入蚂蚁金服生态，" +
...
<style>
    ...
    .comment .inside .content h4{
        margin-bottom: 10px;
        cursor: pointer;
    }

    .comment .inside .content h4:hover{
        color:#2b85e4;
    }

    .comment .inside .content .p{
        max-width:720px ;
        font-size:14px;
        color: rgba(0,0,0,.45);
        margin-top: 10px;
    ...
    .comment .inside .content .user{
        margin:16px 0 0 0;
        font-size: 14px;
        color: rgba(0,0,0,.45);
    }

    .comment .inside .content .user em{
        margin-left: 30px;
        display: inline-block;
    }

    .comment .inside .content .user a{
        cursor: pointer;
    }

    .comment .inside .content .imgs{
        display: inline-block;
        width:20px;
        height:20px;
        margin-right: 5px;
    ...
    .comment .inside .content .imgs img{
        width:100%;
        height:100%;
        border-radius: 50%;
    }
